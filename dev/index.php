		...
		<main class="page-dev">
			...
			<section>
				...
				<div class="header-container-up">
					<header>
						<h1>Разработка корпоративных сайтов<br> в сферах производства, медицины, недвижимости</h1>
					</header>
				</div>
				...
				<div class="header-container-down">
					<div class="row">
						<div class="col-md-6">
							<p>Проектирование сайта или веб-приложения (сбор и анализ требований, разработка технического задания, проектирование интерфейсов);</p>

							<p>Разработка креативной концепции сайта;</p>

							<p>Создание дизайн-концепции сайта;</p>

							<p>Создание макетов страниц;</p>

							<p>Вёрстка страниц и шаблонов;</p>

							<p>Программирование (разработка функциональных инструментов) или интеграция в систему управления содержимым (CMS);</p>

							<p>Оптимизация и размещение[уточнить] материалов сайта;</p>

							<p>Тестирование и внесение корректировок;</p>

							<p>Открытие проекта на публичной площадке;</p>

							<p>Обслуживание работающего сайта или его программной основы.</p>
						</div>
						<div class="col-md-6">
							<div class="header-right-block">

								<div class="header-block-text">
									<p>Мы такие классные, прям слов нет,  что бы сюда написать</p>

									<p>Приходите, у нас есть кофе-машина, практически не сломанная</p>

									<p>Какие еще вам нужны доказательства?</p>
								</div>
			...
			<section>
				...
				<div class="row not-margin">
					<h2>Примеры наших работ по разработке сайтов</h2>
			...
			<section class="content-container faq">
				<header>
				...
				<div class="row">
					<article class="col-md-6">
						<header>
							<h3>А че так дорого?</h3>
						</header>
						<p>
							Ежедневно в Сети появляются тысячи новых сайтов, большинство из которых являются незаконченными, поскольку их владельцы действительно не знают о недоделках либо же просто забывают/ленятся доработать свои проекты. Это проблема, последствия которой могут негативно повлиять на доверие пользователей и авторитет сайта.
						</p>
					</article>
					<article class="col-md-6">
						<header>
			...
			<section class="crm">
				<div class="content-container">	
					<header>
						<h2>Разработка CRM-систем<br> для недвижимости и цветочного бизнеса</h2>
					</header>
				</div> 
			...
			<section class="mobile-app">
				<div class="content-container">	
				<header>
					<h2>Разработка мобильных<br> приложений для Android, WinPhone, IOS</h2>
				</header>
				</div>
