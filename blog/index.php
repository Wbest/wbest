...
?>
		...
		<div class="module module--vertical">
						...
						<li class="glide__slide">
							<div class="box">
								...
								<article class="box-content">
									<header>
										<h2>15 вещей, которые нужно учесть перед запуском нового сайта</h2>
									</header>
		...
		<script>
			...
			if((heightScreen>=705) && (heightScreen<850)){
				paddingSize='16%';
				$('.header-mask').css('height','18%');
				$('.footer-mask').css('height','14%');
			}else if((heightScreen>=850) && (heightScreen<1150)){
				paddingSize='23%';
				$('.header-mask').css('height','25%');
				$('.footer-mask').css('height','21%');
			}
