...
?>
		...
		<main class="page-projects">
			<section class="start-page-projects">
					<header>
				...
				<div id="container-projects" class="row not-margin">
					...
					<div class="col-md-12 full-block-project hippocrates-full mix category-1">
						...
						<h2>Гипократ</h2>
							...
							<p>
							Разработка корпоративного<br> сайта для медицинского учреждения
							</p>
					...
					<div class="col-md-12 full-block-project asm-full mix category-2">
						...
						<h2>ASM</h2>
							...
							<p>
							Разработка корпоративного<br> сайта для производственного предприятия
							</p>
					...
					<div class="col-md-12 full-block-project authority-full mix category-1">
						...
						<h2>Авторитет</h2>
							...
							<p>
							Разработка корпоративного<br> сайта агенства недвижимости
							</p>
					...
					<div class="col-md-12 full-block-project promtekh-full mix category-2">
						...
						<h2>Промтехносталь</h2>
							...
							<p>
							Разработка корпоративного<br> сайта для группы компаний
							</p>
					...
					<div class="col-md-12 full-block-project csbu-full mix category-1">
						...
						<h2>ЦСБУ</h2>
							...
							<p>
							Разработка корпоративного<br> сайта для страховой компании
							</p>
					...
					<div class="col-md-12 full-block-project promtehsnast-full mix category-2">
						...
						<h2>Промтехоснастка</h2>
							...
							<p>
							Разработка корпоративного<br> сайта для производственной компании
							</p>
					...
					<div class="col-md-12 full-block-project floors-full mix category-2">
						...
						<h2>ТДК Этажи</h2>
							...
							<p>
							Разработка корпоративного<br> сайта торгово-делового комплекса
							</p>
					...
					<div class="col-md-12 projects-more-container">
