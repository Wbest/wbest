		...
		<div class="page-mask"></div>
			...
			<section>
				...
				<div class="header-container-up">
					<header>
						<h1>Комплексное продвижение<br> в интернете</h1>
					</header>
				</div>
				...
				<div class="header-container-down">
					<div class="row">
						<div class="col-md-6 not-padding">
							<ul>
								<li>Анализ содержания и структуры вашего сайта, подбор поисковых запросов, настройка целей, установка систем аналитики;</li>

								<li>Оптимизация сайта по рекомендации Яндекс, Google</li>

								<li>Работа с внешними факторами продвижения;</li>

								<li>Настройка контекстной рекламы и SMM-стратегии;</li>

								<li>Работа с поведенческими факторами;</li>

								<li>Анализ качества тарфика, формирование отчетов.</li>
							</ul>
						</div>
