<?
	...
	{
		$sql = "DELETE FROM `floor` WHERE `id` = ".$_GET['del_floor']."";
		mysql_query($sql);
	}
	if (isset($_GET['del_flat']))
	{
		$sql = "DELETE FROM `flat` WHERE `id` = ".$_GET['del_flat']."";
		mysql_query($sql);
	}
	if (isset($_GET['page']))
	{
		  ...
		  ?>
			...
			<tr>
			  ...
			  <td>
				  <table>
				  <?
					$SQL = "SELECT * FROM `floor` WHERE `id_complex`=".$id." ORDER BY `id`";
					...
					for ($j = 0; $j < $count_floor; ++$j)
					{
						...
						?><tr><td style="width: 4.5em;"><?echo $name_floor;?></td><td style="width: 2.0em;"><a href="/pn/floor.php?edit=<?echo $id_floor;?>"><i class="fa fa-pencil"></i></a></td><td style="width: 2.0em;"><a href="/pn/<?echo $page_url;?>.php?page=<?echo $page;?>&del_floor=<?echo $id_floor;?>"><i class="fa fa-trash-o"></i></a></td></tr><?
					}
				  ?>
				  </table>
					<a href="/pn/floor.php?add=<?echo $id;?>">Добавить этаж</a>
			  </td>
			  <td>
				  <table>
				  <?
					$SQL = "SELECT * FROM `flat` WHERE `id_complex`=".$id." ORDER BY `id`";
					...
					for ($j = 0; $j < $count_flat; ++$j)
					{
						...
						?><tr><td style="width: 8.5em;">Квартира № <?echo $number_flat;?></td><td style="width: 2.0em;"><a href="/pn/flat.php?edit=<?echo $id_flat;?>"><i class="fa fa-pencil"></i></a></td><td style="width: 2.0em;"><a href="/pn/<?echo $page_url;?>.php?page=<?echo $page;?>&del_flat=<?echo $id_flat;?>"><i class="fa fa-trash-o"></i></a></td></tr><?
					}
				  ?>
				  </table>
					<a href="/pn/flat.php?add=<?echo $id;?>">Добавить квартиру</a>
